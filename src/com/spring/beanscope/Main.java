...
public class Main {
    public static void main(String[] args) {
         ...
         */
        File file = new File("src/com/spring/beanScope/container.xml");
         ...
         */
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("com/spring/beanscope/container.xml");
        /**
