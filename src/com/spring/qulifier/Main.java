...
public class Main {
    public static void main(String[] args) {
         ...
         */
        File file = new File("src/com/spring/qulifier/container.xml");
        System.out.println("File Exist : " + file.exists());
        /**
         *create new Object From ClassPathXmlApplicationContext
         */
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("com/spring/qulifier/container.xml");
        /**
         ...
         */
        ZooInterface zi= context.getBean("zoo", ZooInterface.class);
        zi.getAnimalName();
